    ...
    <div>
      ...
      {/* <div className="hidden print:block bg-gray-100 print-section p-4 sm:p-8">
        <header className="mb-4">
          <h1 className="text-2xl font-semibold text-gray-800 tracking-wide">Purchase Return Details</h1>
        </header>
          ...
          <section className="border-b border-gray-400">
            ...
            <div className="flex flex-row">
              <div className="w-1/2 p-4 border-r border-gray-400 space-y-1">
                ...
                <p className="text-gray-700 tracking-wide">{purchaseReturnData?.returnId1 || "N/A"}</p>
              </div>
            ...
            <div className="w-full p-4 text-sm text-gray-700 tracking-wide border-t border-gray-400">
              <div className="flex flex-col">
                <span className="font-semibold text-gray-800">Return Amount :</span>
                <span>{purchaseReturnData?.returnAmount?.toFixed(2) || "0.00"}</span>
              </div>
            </div>
          </section>

          <section className="w-full">
            <table className="w-full text-sm text-left text-gray-800 border border-gray-400 border-collapse">
              <thead>
                <tr className="font-semibold border-b border-gray-400 tracking-wide">
                  <th className="py-2 px-2">Item Name</th>
                  <th className="py-2 px-2">Batch Number</th>
                  <th className="py-2 px-2">Bill Number</th>
                  <th className="py-2 px-2">Supplier</th>
                  <th className="py-2 px-2">Return Type</th>
                  <th className="py-2 px-2">Return Quantity</th>
                  <th className="py-2 px-2">Discrepancy In</th>
                  <th className="py-2 px-2">Discrepancy</th>
                </tr>
              </thead>
              <tbody>
                {purchaseReturnData?.purchaseReturnItemDtos?.map((item, index) => (
                  <tr key={index} className="border-b border-gray-400 tracking-wide text-gray-700">
                    <td className="py-2 px-2 font-semibold text-gray-800">{item.itemName || "Unknown Item"}</td>
                    <td className="py-2 px-2">{item.batchNo || "N/A"}</td>
                    <td className="py-2 px-2">{purchaseReturnData?.purchaseBillNo || "N/A"}</td>
                    <td className="py-2 px-2">{supplier || "N/A"}</td>
                    <td className="py-2 px-2">{item.returnType || "N/A"}</td>
                    <td className="py-2 px-2">{item.returnQuantity || 0}</td>
                    <td className="py-2 px-2">{item.discrepancyIn || "N/A"}</td>
                    <td className="py-2 px-2">{item.discrepancy || "N/A"}</td>
                  </tr>
                ))}
              </tbody>
            </table>
  ...
  <main className="bg-white border border-gray-400 print:w-full print:max-w-full print:overflow-hidden">
    ...
    <section className="w-full overflow-x-auto print:overflow-visible">
      <table className="w-full table-fixed text-sm text-left text-gray-800 border border-gray-400 border-collapse print:text-xs">
        <thead>
          <tr className="font-semibold border-b border-gray-400 tracking-wide">
            <th className="py-2 px-2 border border-gray-400 break-words">Item Name</th>
            <th className="py-2 px-2 border border-gray-400 break-words">Batch Number</th>
            <th className="py-2 px-2 border border-gray-400 break-words">Bill Number</th>
            <th className="py-2 px-2 border border-gray-400 break-words">Supplier</th>
            <th className="py-2 px-2 border border-gray-400 break-words">Return Type</th>
            <th className="py-2 px-2 border border-gray-400 break-words">Return Quantity</th>
            <th className="py-2 px-2 border border-gray-400 break-words">Discrepancy In</th>
            <th className="py-2 px-2 border border-gray-400 break-words">Discrepancy</th>
          </tr>
        </thead>
        <tbody>
          {purchaseReturnData?.purchaseReturnItemDtos?.map((item, index) => (
...
// // the code belwo is written which is the original code ...............................
