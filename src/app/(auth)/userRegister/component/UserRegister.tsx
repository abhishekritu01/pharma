...
const UserRegister: React.FC<UserRegisterProps> = ({ setShowRegister }) => {
      ...
      <div className="max-w-md mx-auto">
        ...
        >
          ...
          <p className="text-gray-600">
            Already registered?{" "}
            <span
              className="text-Purple underline underline-offset-4 cursor-pointer"
              onClick={() => setShowRegister(false)} // 👈 go back to login
            >
