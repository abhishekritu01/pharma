            ...
            <li key={item.name}>
              {!item.children ? (
                <Link
                  ...
                  className={clsx(
                    selectedItem === item.name ? "bg-purple-400 text-white" : "hover:bg-purple-200",
                  ...
                  {({ open }) => (
                    <>
                      ...
                      >
                        ...
                        {isOpen && (
                          <ChevronRightIcon
                            className={clsx("ml-auto h-4 w-4 transition-transform duration-200", { "rotate-90": open })}
                          />
                        )}
                      </DisclosureButton>
                      {isOpen && open && (
                          ...
                          {item.children?.map((subItem) => (
                            <li key={subItem.name}>
                              <Link
                                ...
                                className={clsx(
                                  selectedItem === subItem.name ? "bg-purple-400 text-white" : "hover:bg-purple-200",
